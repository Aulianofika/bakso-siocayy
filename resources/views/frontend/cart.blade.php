...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('menu') }}" class="btn btn-outline-success rounded-pill d-none d-md-inline-flex align-items-center">
    ...
    @else
        <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
                            ...
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-7 col-md-4">
                                    ...
                                    <div class="d-md-none">
                                        ...
                                        <span class="fw-semibold text-success price" data-price="{{ $item->product->price_sale }}">
                                ...
                                <div class="d-none d-md-block col-md-2 text-center">
                                    <span class="fw-semibold text-muted price desktop-price" data-price="{{ $item->product->price_sale }}">
                                        Rp {{ number_format($item->product->price_sale, 0, ',', '.') }}
                                    </span>
                                </div>
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="d-flex align-items-center justify-content-between justify-content-md-center bg-light rounded-pill p-1 border">
                                        <button type="button" class="btn btn-sm btn-link text-decoration-none text-success p-0 quantity-btn decrease" style="width: 30px; height: 30px;">
                                            <i class="bi bi-dash-circle-fill fs-5"></i>
                                        </button>
                                        <input type="text" readonly class="form-control-plaintext text-center fw-bold quantity-text p-0" 
                                               value="{{ $item->quantity }}" data-quantity="{{ $item->quantity }}" style="width: 40px;">
                                        <button type="button" class="btn btn-sm btn-link text-decoration-none text-success p-0 quantity-btn increase" style="width: 30px; height: 30px;">
                                ...
                                {{-- Subtotal & Delete --}}
                                <div class="col-12 col-md-2 d-flex justify-content-between align-items-center justify-content-md-end mt-3 mt-md-0">
                                    <div class="d-md-none">
                ...
                <div class="p-4 bg-light">
                    <div class="row align-items-center gy-3">
                        <div class="col-12 col-md-6">
                            <div class="d-flex align-items-center justify-content-between justify-content-md-start gap-md-3">
                        ...
                        <div class="col-12 col-md-6 text-md-end d-flex gap-2 justify-content-end">
                            ...
                            <a href="{{ route('menu') }}" class="btn btn-outline-success rounded-pill d-md-none flex-grow-1">
                                <i class="bi bi-shop"></i> Belanja
                            </a>
                            <button type="submit" class="btn btn-success rounded-pill px-4 py-2 shadow-sm flex-grow-1 flex-md-grow-0">
            ...
            {{-- Hidden Delete Forms --}}
            @foreach($cartItems as $item)
                <form id="delete-form-{{ $item->id }}" action="{{ route('cart.remove', $item->id) }}" method="POST" class="d-none" onsubmit="return confirm('Yakin ingin menghapus menu ini?')">
                    @csrf
                    @method('DELETE')
                </form>
            @endforeach
