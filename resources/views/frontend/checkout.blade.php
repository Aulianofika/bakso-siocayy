...
@section('content')
    <div class="container py-4">
        ...
        <div class="d-flex align-items-center mb-4">
            <a href="{{ route('cart.index') }}" class="btn btn-outline-secondary rounded-circle me-3 shadow-sm"
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="no_telepon" class="form-control rounded-3" placeholder="08xxx"
                                            required oninvalid="this.setCustomValidity('Mohon isi nomor telepon anda')"
                                            oninput="this.setCustomValidity('')">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label fw-semibold small text-muted">Alamat Lengkap</label>
                                        <textarea name="alamat" class="form-control rounded-3" rows="3"
                                            placeholder="Jalan, RT/RW, Nomor Rumah..." required
                                            oninvalid="this.setCustomValidity('Mohon isi alamat lengkap anda')"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="kecamatan" class="form-control rounded-3"
                                            ...
                                            oninvalid="this.setCustomValidity('Mohon isi kecamatan')"
                                            oninput="this.setCustomValidity('')">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label fw-semibold small text-muted">Kabupaten/Kota</label>
                                        <input type="text" name="kabupaten" class="form-control rounded-3"
                                            placeholder="Kabupaten/Kota" required
                                            oninvalid="this.setCustomValidity('Mohon isi kabupaten/kota')"
                                            oninput="this.setCustomValidity('')">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label fw-semibold small text-muted">Kode Pos</label>
                                        <input type="text" name="kode_pos" class="form-control rounded-3" placeholder="Kode Pos"
                                            required oninvalid="this.setCustomValidity('Mohon isi kode pos')"
                                            oninput="this.setCustomValidity('')">
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <textarea name="catatan" class="form-control rounded-3" rows="2"
                                            placeholder="Pesan untuk penjual..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-6">
                                        <label class="cursor-pointer w-100">
                                            <input type="radio" name="payment_method" value="cash" class="btn-check" id="cod"
                                                checked>
                                            <div class="payment-card border rounded-4 p-3 text-center h-100 position-relative">
                                                ...
                                                <div class="check-icon"><i class="bi bi-check-circle-fill text-success"></i>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                    <div class="col-6">
                                        <label class="cursor-pointer w-100">
                                            <input type="radio" name="payment_method" value="transfer" class="btn-check"
                                                id="transfer">
                                            <div class="payment-card border rounded-4 p-3 text-center h-100 position-relative">
                                ...
                                <div id="transfer-section" class="d-none animate-fade-in">
                                    <div class="bg-light rounded-4 p-4 text-center border">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <p class="mb-0 h5 font-monospace">5468 0102 2414 539</p>
                                            <small class="text-muted">a.n Chairulsalam</small>
                                        </div>
                                        ...
                                        <div class="text-start">
                                            ...
                                            <input type="file" name="bukti_transfer" id="bukti_transfer"
                                                ...
                                                oninvalid="this.setCustomValidity('Mohon upload bukti transfer')"
                                                oninput="this.setCustomValidity('')">
                                            <small class="text-muted d-block mt-1 fst-italic">*Wajib upload bukti jika via
                                                transfer</small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="card border-0 shadow-sm rounded-4 position-sticky" style="top: 20px;">
                            <div class="card-body p-4">
                                    ...
                                    @foreach($cartItems as $item)
                                        <div class="d-flex align-items-center mb-3">
                                            <img src="{{ asset('images/products/' . $item->product->image) }}"
                                                class="rounded-3 me-3 object-fit-cover bg-light" style="width: 60px; height: 60px;">
                                            <div class="flex-grow-1">
                                                <h6 class="fw-semibold mb-0 text-dark">{{ $item->product->name }}</h6>
                                                <small class="text-muted">{{ $item->quantity }} x Rp
                                                    {{ number_format($item->product->price_sale, 0, ',', '.') }}</small>
                                            </div>
                                ...
                                <button type="submit"
                                    class="btn btn-success w-100 rounded-pill py-3 fw-bold shadow-sm hover-scale">
                                    Buat Pesanan
                                </button>
                            </div>
                        </div>
